...
inexact_search = newton_method.create_inexact_linesearch(testFunction1, alpha_init=1, direction=direction)
...
print("Minimum for x**3 + 2xy + y**6")
minimum = bfgs.optimize(testFunction1, x0, dx=dx, termination_criterion=newton_method.residual_criterion, line_search=inexact_search, tol=10**-4)
